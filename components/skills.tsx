export default function Skills() {
  const skillCategories = [
    {
      title: "Frontend",
      skills: ["HTML", "CSS", "Flutter", "React", "Tkinter", "Tailwind CSS"],
    },
    {
      title: "Backend/Database",
      skills: ["Express", "Node.js", "MariaDB", "MongoDB"],
    },
    {
      title: "Miscellaneous",
      skills: ["Git", "Dart", "Python", "C", "R", "R Shiny", "SQL", "JavaScript", "Java", "JavaFX", "Google Firebase"],
    },
    {
      title: "Design",
